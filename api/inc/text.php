...
$text = array(
	...
	'display' => array('Display Options', array(
		...
		'popupForceX' => "Force the X position of the jqm builtin popup mode. (top left corner) - must supply both, and set 'popupPosition' to 'origin'",
		'popupForceY' => "Force the Y position of the jqm builtin popup mode. (top left corner) - must supply both, and set 'popupPosition' to 'origin'",
		'popupPosition' => "Control how the jqm builtin popup mode positions.  Set to 'window' to center in the open window.  Set to an '#id' to center over that element. When set to false, allow datebox to center over the input element (if it has a named id), or in the window.  Set to 'origin' to use X/Y coordinates.",
	...
	'limiting' => array('Data Limiting Options', array(
		...
		'beforeToday' => "",
		'notToday' => "",
		'maxDays' => "Only accept dates that are today + # of days in the future. (no limit on past dates). Corresponds to the html max attribute",
		'minDays' => "Only accept dates that are today - # of days in the past. (no limit on future dates). Corresponds to the html min attribute",
		'maxYear' => "",
		'minYear' => "",
	...
	'i18n' => array('Internationalization Options (overrideOptionName)', array(
		...
		'headerFormat' => "See <a href='http://dev.jtsage.com/jQM-DateBox/doc/3-3-output.php'>dev.jtsage.com/jQM-DateBox/doc/3-3-output.php</a> for valid options.",
		'tooltip' => "",
		'nextMonth' => "",
		'prevMonth' => "",
		'dateFieldOrder' => "",
		'timeFieldOrder' => "",
		'slideFieldOrder' => "",
		'dateFormat' => "See <a href='http://dev.jtsage.com/jQM-DateBox/doc/3-3-output.php'>dev.jtsage.com/jQM-DateBox/doc/3-3-output.php</a> for valid options.",
		'useArabicIndic' => "",
		'isRTL' => "",
		...
		'durationFormat' => "",
		'calDateListLabel' => "",
		'calHeaderFormat' => "See <a href='http://dev.jtsage.com/jQM-DateBox/doc/3-3-output.php'>dev.jtsage.com/jQM-DateBox/doc/3-3-output.php</a> for valid options.",
