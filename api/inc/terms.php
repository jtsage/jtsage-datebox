...
$opt = array(
	'common' => array( 'Common Options', array(
		...
		'defaultValue' => array(false, 'Default value for the date', 'Array/String', true),
		'showInitialValue' => array(false, 'Auto-fill Input field on initialization', 'Boolean', true),
		'startOffsetYears' => array(false, 'Offset the start year by #', 'Integer', array(1,1,1,1,0,0,0)),
		'startOffsetMonths' => array(false, 'Offset the start month by #', 'Integer', array(1,1,1,1,0,0,0)),
		'startOffsetDays' => array(false, 'Offset the start day by #', 'Integer', array(1,1,1,1,0,0,0))
	)),
	'display' => array('Display Options', array(
		...
		'zindex' => array(1100, 'Z-Index of controls', 'Integer', true),
		...
		'popupForceX' => array(false, 'Force the X position of the opened control', 'Number', true),
		'popupForceY' => array(false, 'Force the Y position of the opened control', 'Number', true),
		...
		'useInline' => array(false, 'Show control inline in the page', 'Boolean', true),
		'useInlineBlind' => array(false, 'Show the control inline in the page when opened', 'Boolean', true),
		...
		'useAltIcon' => array(false, 'useNewStyle: alternate light icon', 'Boolean', true),
		'overrideStyleClass' => array(false, 'useNewStyle: custom icon class', 'String', true)
	)),
	'control' => array('Control Options', array(
		...
		'useClearButton' => array(false, 'Show a button to clear the Input', 'Boolean', true),
	...
	'limiting' => array('Data Limiting Options', array(
		...
		'blackDatesRec' => array(false, 'Do not allow these recurring dates to be selected', 'Array', array(1,1,1,1,0,0,0)),
		'blackDates' => array(false, 'Do not allow these ISO dates to be selected', 'Array', array(1,1,1,1,0,0,0)),
		'blackDays' => array(false, 'Do not allow these days to be selected', 'Array', array(1,1,1,1,0,0,0)),
		'enableDates' => array(false, 'Allow *only* these ISO dates to be selected', 'Array', array(0,1,0,0,0,0,0)),
		'whiteDates' => array(false, 'Always allow these ISO dates to be selected', 'Array', array(1,1,1,1,0,0,0)),
		...
		'validHours' => array(false, 'Limit times to *only* these hours', 'Array', array(0,0,0,0,1,1,0)),
		...
		'highDays' => array(false, 'Highlight these days', 'Array', array(0,1,0,0,0,0,0)),
		'highDates' => array(false, 'Highlight these ISO dates', 'Array', array(0,1,0,0,0,0,0)),
		'highDatesRec' => array(false, 'Highlight these recurring dates', 'Array', array(0,1,0,0,0,0,0)),
		'highDatesAlt' => array(false, 'Highlight these ISO dates (alternate)', 'Array', array(0,1,0,0,0,0,0)),
		'calShowDateList' => array(false, 'Show Special Date List Picker', 'Boolean', array(0,1,0,0,0,0,0)),
		'calDateList' => array(false, 'Array of dates for Date List Picker', 'Array', array(0,1,0,0,0,0,0)),
	...
	'themes' => array('Theme Options', array(
		...
		'themeDatePick' => array('b', 'Theme swatch for choosen date', 'String', array(0,1,1,1,0,1,0)),
		...
		'calYearPickMin' => array(-6, 'Lower limit for Year Picker', 'Mixed', array(0,1,0,0,0,0,0)),
		'calYearPickMax' => array(6, 'Upper limit for Year Picker', 'Mixed', array(0,1,0,0,0,0,0)),
