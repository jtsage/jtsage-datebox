...
var langs = [{"data":[
	"en: English US", "af: Afrikaans", "ar: العربية", "bg: български език", "ca: Català", "cs: Čeština",
	"da: Dansk", "de: Deutsch", "el: ελληνικά", "es-ES: Español", "fi: Suomi", "fr: Français", "he: עברית",
	"hr: Hrvatski Jezik", "hu: Magyar", "id: Bahasa Indonesia", "it: Italiano", "ja: 日本語", "ko: 한국어",
	"lt: Lietuvių Kalba", "nl: Nederlands", "nl-BE: Nederlands	, Belgium", "no: Norsk", "pl: Język Polski",
	"pt-BR: Português", "pt-PT: Português", "ro: Limba Română", "ru: русский язык", "sl: Slovenski Jezik",
	"sr: српски језик", "sv-SE: Svenska", "th: ไทย", "tr: Türkçe", "uk: українська мова", "vi: Tiếng Việt",
