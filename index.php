...
<div data-role="page" data-theme="a" id="main"> 
	...
	<div data-role="content" data-theme="c">
		<form method="post" action="#">
			...
			<div data-role="fieldcontain"><label for="date5">Android Style, Forced Popup, Day-Month-Year display</label><input value="2011-01-01" name="date5" type="date" data-role="datebox" id="date5" data-options='{"useDialogForceFalse": true, "fieldsOrder": ["d", "m", "y"]}'/>	</div>
			<div data-role="fieldcontain"><label for="date6">Calendar Style, Forced Popup</label><input value="2011-01-01" name="date6" type="date" data-role="datebox" id="date6" data-options='{"mode": "calbox", "useDialogForceFalse": true}'/>	</div>
			<div data-role="fieldcontain"><label for="date7">Calendar Style, This Month Only, Modal Style</label><input value="2011-01-01" name="date7" type="date" data-role="datebox" id="date7" data-options='{"mode": "calbox", "calShowOnlyMonth": true, "useModal": true}'/>	</div>
