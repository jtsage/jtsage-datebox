...
f.write("\t\theaderFormat: '"+raw_input("Format for date header <%A, %B %-d, %Y> : ")+"',\n")
f.write("\t\tdateFormat: '"+raw_input("Format for dates <%Y-%m-%d> : ")+"',\n")
f.write("\t\ttooltip: '"+raw_input("Mouseover tooltip for open button <Open Date Picker> : ")+"',\n")
f.write("\t\tnextMonth: '"+raw_input("Mouseover tooltip for next month button <Next Month> : ")+"',\n")
f.write("\t\tprevMonth: '"+raw_input("Mouseover tooltip for previous month button <Previous Month> : ")+"',\n")
