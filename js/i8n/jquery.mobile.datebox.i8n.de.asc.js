...
jQuery.extend(jQuery.mobile.datebox.prototype.options.lang, {
	'de': {
		...
		titleDateDialogLabel: 'Datum ausw&auml;hlen',
		titleTimeDialogLabel: 'Zeit ausw&auml;hlen',
		daysOfWeek: ['Sonntag','Montag','Dienstag','Mittwoch','Donnerstag','Freitag','Samstag'],
		daysOfWeekShort: ['So','Mo','Di','Mi','Do','Fr','Sa'],
		monthsOfYear: ['Januar','Februar','&auml;rz','April','Mai','Juni','Juli','August','September','Oktober','November','Dezember'],
		monthsOfYearShort: ['Jan','Feb','M&auml;r','Apr','Mai','Jun','Jul','Aug','Sep','Oct','Nov','Dez'],
